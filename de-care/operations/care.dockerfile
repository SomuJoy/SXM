...
COPY ./dist/apps/de-care /usr/share/nginx/html
...
ENV ACESS_TOKEN_DURATION_VALUE_IN_DAYS=30
ENV REFRESH_TOKEN_DURATION_VALUE_IN_MINUTES=120

ENV MODE=prod

ENV ENABLE_CMS_CONTENT=true
