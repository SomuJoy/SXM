...
export const environment = {
    production: false,
    settings: {
        apiUrl: 'https://dex-dev.corp.siriusxm.com/dvgllvdexoac04-17425-care',
        apiPath: '/services',
        oacUrl: 'https://careqa.siriusxm.com/OAC-US-1525/',
        ...
        caOemAppUrl: 'https://dex-dev.corp.siriusxm.com/dvgllvdexoac05-17521-care/subscribe/checkout',
        featureFlags: {
