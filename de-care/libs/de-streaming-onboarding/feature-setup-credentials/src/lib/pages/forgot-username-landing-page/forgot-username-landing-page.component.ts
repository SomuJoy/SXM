...
@Component({
    selector: 'de-streaming-onboarding-forgot-username-landing-page',
    ...
    constructor(
        ...
        this._store
            ...
            .subscribe((queryParams) => {
                ...
                if (queryParams === 'stitcher') {
                    this._store.dispatch(behaviorEventReactionFeatureTransactionStarted({ flowName: 'credentialrecovery', flowVariation: 'iapstitcher' }));
                }
                if (queryParams === 'nugs') {
                    this._store.dispatch(behaviorEventReactionFeatureTransactionStarted({ flowName: 'credentialrecovery', flowVariation: 'iapnugs' }));
                }
                if (queryParams === 'profileportal') {
                    this._store.dispatch(behaviorEventReactionFeatureTransactionStarted({ flowName: 'credentialrecovery', flowVariation: 'iapprofileportal' }));
                } else {
