...
import { of } from 'rxjs';
import { SharedSxmUiUiPlanComparisonGridModule } from './plan-comparison-grid.component';
...
const retailPricesTwoPlans: RetailPriceAndMrdEligibility[] = [
    { pricePerMonth: 10.99, mrdEligible: false },
    {
        pricePerMonth: 21.99,
        mrdEligible: true,
...
const retailPricesCancel: RetailPriceAndMrdEligibility[] = [
    {
        pricePerMonth: 21.99,
        mrdEligible: true,
    },
        ...
        channels: [
            {
                ...
                features: [
                    ...
                    },
                    {
                        ...
                        count: null,
                        tooltipText:
                            'Play-by-play from your hometown crew, along with 24/7 exclusive MLB, NBA, NHL, and PGA channels. Plus dedicated Fantasy Sports channels.',
                    },
                    {
                        name: '24/7 news, talk, sport and comedy',
                        count: null,
...
const packagesCancel: { packageName: string; pricePerMonth: number }[] = [
    {
        packageName: 'SXM_SIR_ALLACCESS_FF',
        pricePerMonth: 21.99,
    },
...
const stories = storiesOf('shared/sxm-ui/plan-comparison-grid', module)
    .addDecorator(withA11y)
    .addDecorator(withKnobs)
    .addDecorator(
        moduleMetadata({
            imports: [OffersModule, SharedSxmUiUiPlanComparisonGridModule, BrowserAnimationsModule],
...
stories.add('default', () => ({
    ...
    template: `<sxm-ui-plan-comparison-grid [packageNames]="packageNames" [retailPrices]="retailPrices" [planComparisonGridParams]="planSelectionData"></sxm-ui-plan-comparison-grid>`,
    props: {
...
stories.add('expandable-grid', () => ({
    ...
    template: `<sxm-ui-plan-comparison-grid collapsedText="Show more features" expandedText="Show less features" [hasWhereToListenRow]="true" [activateExpandable]="true" [packageNames]="packageNames" [retailPrices]="retailPrices" [planComparisonGridParams]="planSelectionData"></sxm-ui-plan-comparison-grid>`,
    props: {
        packageNames: ['SXM_SIR_AUD_PKG_MM', 'SXM_SIR_EVT', 'SXM_SIR_ALLACCESS_FF'],
        planSelectionData: {
            trialEndDate,
...
stories.add('two plans', () => ({
    ...
    template: `<sxm-ui-plan-comparison-grid collapsedText="Show more features" expandedText="Show less features" [hasWhereToListenRow]="true" [activateExpandable]="true" [packageNames]="packageNames" [retailPrices]="retailPrices" [planComparisonGridParams]="planSelectionData"></sxm-ui-plan-comparison-grid>`,
    props: {
        packageNames: ['SXM_SIR_AUD_PKG_MM', 'SXM_SIR_ALLACCESS_FF'],
        planSelectionData: {
            trialEndDate,
            packagesTwoPlans,
            leadOfferTerm,
            selectedPackageName: 'SXM_SIR_AUD_PKG_MM',
            leadOfferPackageName: 'SXM_SIR_AUD_PKG_MM',
        } as PlanComparisonGridParams,
        retailPrices: retailPricesTwoPlans,
    },
}));
...
stories.add('cancel-offer-grid', () => ({
    ...
    template: `<div class="cancel-offer-grid"><sxm-ui-plan-comparison-grid [hasWhereToListenRow]="true" [activateExpandable]="true" [packageNames]="packageNames" [retailPrices]="retailPrices" [planComparisonGridParams]="planComparisonData"></sxm-ui-plan-comparison-grid></div>`,
    props: {
        packageNames: ['SXM_SIR_ALLACCESS_FF', 'SXM_SIR_EVT', 'SXM_SIR_AUD_PKG_MM'],
        planComparisonData: {
            trialEndDate,
            packages: packagesCancel,
            leadOfferTerm,
            selectedPackageName,
            leadOfferPackageName,
        } as PlanComparisonGridParams,
        retailPrices: retailPricesCancel,
