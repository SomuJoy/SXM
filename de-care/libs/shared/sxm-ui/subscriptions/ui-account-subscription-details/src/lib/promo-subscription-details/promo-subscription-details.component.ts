...
@Component({
    selector: 'sxm-ui-promo-subscription-details',
    templateUrl: './promo-subscription-details.component.html',
    styleUrls: ['./promo-subscription-details.component.scss'],
})
export class SxmUiPromoSubscriptionDetailsComponent implements ComponentWithLocale {
...
@NgModule({
    declarations: [SxmUiPromoSubscriptionDetailsComponent],
    exports: [SxmUiPromoSubscriptionDetailsComponent],
    imports: [CommonModule, TranslateModule.forChild(), SharedSxmUiDropdownNavigationListModule, SharedSxmUiUiDatePipeModule],
})
export class SharedSxmUiSubscriptionDetailsUiPromoSubscriptionDetailsModule {}
