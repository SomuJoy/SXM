...
import { SharedSxmUiUiCompactQuoteModule } from '../shared-sxm-ui-ui-compact-quote.module';
import { CompactQuoteData } from './compact-quote-summary.component';
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';

const stories = storiesOf('Component Library/UI/Compact Quotes/Compact Quote Summary', module)
    .addDecorator(
        moduleMetadata({
            imports: [BrowserAnimationsModule, SharedSxmUiUiCompactQuoteModule],
...
stories.add('default', () => ({
    template: `<de-care-compact-quote-summary [compactQuoteData]="compactQuoteData"></de-care-compact-quote-summary>`,
    props: {
        compactQuoteData: {
            title: {
                label: 'Due Today',
