...
import { AccountLookupStepComplete, StepCompleteReasonEnum } from './account-credentials-and-lookup-step.component';
...
@Injectable()
export class AccountCredentialsAndLookupStepStateService {
