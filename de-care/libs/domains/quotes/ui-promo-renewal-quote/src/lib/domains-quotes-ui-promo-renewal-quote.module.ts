...
import { PromoRenewalQuoteComponent } from './promo-renewal-quote/promo-renewal-quote.component';
...
@NgModule({
    ...
    declarations: [PromoRenewalQuoteComponent],
    exports: [PromoRenewalQuoteComponent]
})
export class DomainsQuotesUiPromoRenewalQuoteModule extends ModuleWithTranslation {
