...
import { FutureQuoteComponent } from './future-quote/future-quote.component';
...
@NgModule({
    ...
    declarations: [FutureQuoteComponent],
    exports: [FutureQuoteComponent],
})
export class DomainsQuotesUiFutureQuoteModule extends ModuleWithTranslation {
