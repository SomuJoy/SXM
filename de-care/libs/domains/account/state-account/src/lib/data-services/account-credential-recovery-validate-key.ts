...
const ENDPOINT_URL = '/account/credential-recovery/validate-key';
interface Request {
    resetKey;
}
...
export class AccountCredentialRecoveryValidateKeyService extends MicroservicesEndpointService {
