...
import { AccountLookupStepComplete, StepCompleteReasonEnum } from './account-lookup-form.component';
...
import { AccountLookupOutput } from '../lookup/account-lookup/account-lookup.component';
...
@Injectable()
export class AccountLookupFormStateService {
