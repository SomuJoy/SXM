...
export interface PaymentInfoFormComponentApi {
...
@Component({
    selector: 'de-care-payment-info-form',
...
export class PaymentInfoFormComponent implements PaymentInfoFormComponentApi, AfterViewInit, ComponentWithLocale {
    ...
    paymentInfoFormModalAriaDescribedbyTextId = uuid()
