...
import {
    ...
    SubmitPurchaseTargetedTransactionMrdWorkflowService,
    SubmitPurchaseTargetedTransactionMrdWorkflowErrors,
...
@Component({
    selector: 'step-targeted-review-mrd-page',
    templateUrl: './step-targeted-review-mrd-page.component.html',
    styleUrls: ['./step-targeted-review-mrd-page.component.scss'],
...
export class StepTargetedReviewMrdPageComponent implements ComponentWithLocale, OnInit, AfterViewInit {
    ...
    constructor(
        ...
        private readonly _submitPurchaseTargetedTransactionMrdWorkflowService: SubmitPurchaseTargetedTransactionMrdWorkflowService,
    ...
    submitForm() {
        this._submitPurchaseTargetedTransactionMrdWorkflowService.build().subscribe({
            next: () => {
            ...
            error: (error: SubmitPurchaseTargetedTransactionMrdWorkflowErrors) => {
                this._reviewQuoteAndApproveFormComponent.setProcessingCompleted();
                switch (error) {
