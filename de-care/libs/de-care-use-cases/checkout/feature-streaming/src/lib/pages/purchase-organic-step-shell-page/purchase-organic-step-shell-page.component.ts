...
import { Component, ChangeDetectionStrategy, Inject, AfterViewInit, OnDestroy, NgModule } from '@angular/core';
...
@Component({
    selector: 'purchase-organic-step-shell-page',
...
@NgModule({
    ...
    declarations: [PurchaseOrganicStepShellPageComponent],
    exports: [PurchaseOrganicStepShellPageComponent],
})
export class PurchaseOrganicStepShellPageComponentModule {}
