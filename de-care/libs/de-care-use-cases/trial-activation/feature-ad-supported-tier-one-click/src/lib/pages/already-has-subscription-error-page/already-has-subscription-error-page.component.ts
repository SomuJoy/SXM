...
@Component({
    selector: 'de-care-already-has-subscription-error-page',
...
export class AlreadyHasSubscriptionErrorPageComponent implements OnInit, AfterViewInit {
    readonly translateKeyPrefix = 'DeCareUseCasesTrialActivationFeatureAdSupportedTierOneClickModule.AlreadyHasSubscriptionErrorPageComponent';
