...
import { catchError, filter, map, startWith, takeUntil, tap, distinctUntilChanged } from 'rxjs/operators';
...
@Component({
    selector: 'one-step-activation-confirmation',
    templateUrl: './one-step-activation-confirmation.component.html',
    styleUrls: ['./one-step-activation-confirmation.component.scss'],
})
export class OneStepActivationConfirmationComponent implements OnDestroy, OnInit, AfterViewInit {
    private _logPrefix: string = '[One Step Activation Thank You]:';
        ...
        this._activatedRoute.data
            .pipe(
                ...
                tap((flowData) => {
                    ...
                    if (flowData.deal?.type === 'APPLE') {
                        this.deal = flowData.deal;
                    }
                }),
