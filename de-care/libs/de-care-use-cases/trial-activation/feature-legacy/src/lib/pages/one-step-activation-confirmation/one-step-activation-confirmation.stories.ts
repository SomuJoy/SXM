...
// import { OneStepActivationConfirmationComponent } from './one-step-activation-confirmation.component';
...
// ];
//
// const stories = storiesOf('trial-activation/pages/one-step-activation-confirmation', module)
