...
// import { ServiceLaneOneClickConfirmationComponent } from './service-lane-one-click-confirmation.component';
...
// ];
//
// const stories = storiesOf('trial-activation/pages/service-lane-one-click-confirmation', module)
