...
@Component({
    selector: 'de-care-pre-selected-plan',
    templateUrl: './pre-selected-plan.component.html',
    styleUrls: ['./pre-selected-plan.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PreSelectedPlanComponent implements OnInit, ComponentWithLocale {
    ...
    channelDescriptions = ['SXM_APP', 'AD_FREE', 'ORIGINAL_TALK', 'VIDEO_LIBRARY'];
    preSelectedPackageName = 'SIR_IP_SHOWCASE';
