import { Directive, forwardRef, HostListener, ElementRef, Renderer2, Injector } from '@angular/core';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

@Directive({
    selector: '[appMaskExpirationDate]',
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => MaskExpirationDateDirective),
            multi: true
        }
    ]
})
export class MaskExpirationDateDirective implements ControlValueAccessor {
