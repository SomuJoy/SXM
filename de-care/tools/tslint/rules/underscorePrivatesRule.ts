// https://github.com/DanielRosenwasser/underscore-privates-tslint-rule
...
type RelevantClassMember = ts.MethodDeclaration | ts.PropertyDeclaration | ts.GetAccessorDeclaration | ts.SetAccessorDeclaration;
...
function checkNodeForViolations(ctx: Lint.WalkContext<void>, node: ts.Node): void {
    // TODO: add check for constructor method signature params since those can have private syntactic sugar
